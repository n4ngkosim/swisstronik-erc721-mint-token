# Swisstronik Testnet Technical Task 3 (Mint a ERC-721 Token)
...
```bash
git clone https://github.com/leiraz41d/swisstronik-erc721-mint-token.git
```
...
contract TestNFT is ERC721 {
    ...
    constructor() ERC721("LeiraNFT", "LEINFT") {}
